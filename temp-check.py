...
# post to datahub
r = requests.post("https://" + settings.deviceLoggerAPI + "/api/log/", data={'device': 'temp-check-office', 'value1': str(insideTemperature), 'value2': str(insideHumidity) , 'value3': str(apparentTemperature), 'value4': str(humidity), 'value5': str(summary)})
